                                 ...
                                 gr_float *cooling_time)
{
  ...
  /* Call the fortran routine to solve cooling equations. */
    ...
    FORTRAN_NAME(cool_multi_time_g)(
       ...
       &my_rates->alphap.props.data_size,
