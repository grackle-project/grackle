...
void grackle::impl::cool1d_cloudy_old_tables_g(
  ...
  dclPar[0] =
      (my_rates->cloudy_metal
           .grid_parameters[0][my_rates->cloudy_metal.grid_dimension[0] - 1] -
       my_rates->cloudy_metal.grid_parameters[0][0]) /
      (double)(my_rates->cloudy_metal.grid_dimension[0] - 1);
  if (my_rates->cloudy_metal.grid_rank > 1) {
    dclPar[1] =
        (my_rates->cloudy_metal
             .grid_parameters[1][my_rates->cloudy_metal.grid_dimension[1] - 1] -
         my_rates->cloudy_metal.grid_parameters[1][0]) /
        (double)(my_rates->cloudy_metal.grid_dimension[1] - 1);
  }
  if (my_rates->cloudy_metal.grid_rank > 2) {
    dclPar[2] =
        (my_rates->cloudy_metal
             .grid_parameters[2][my_rates->cloudy_metal.grid_dimension[2] - 1] -
         my_rates->cloudy_metal.grid_parameters[2][0]) /
        (double)(my_rates->cloudy_metal.grid_dimension[2] - 1);
  }
  if (my_rates->cloudy_metal.grid_rank > 3) {
    dclPar[3] =
        (my_rates->cloudy_metal
             .grid_parameters[3][my_rates->cloudy_metal.grid_dimension[3] - 1] -
         my_rates->cloudy_metal.grid_parameters[3][0]) /
        (double)(my_rates->cloudy_metal.grid_dimension[3] - 1);
  }
  if (my_rates->cloudy_metal.grid_rank > 4) {
    dclPar[4] =
        (my_rates->cloudy_metal
             .grid_parameters[4][my_rates->cloudy_metal.grid_dimension[4] - 1] -
         my_rates->cloudy_metal.grid_parameters[4][0]) /
    ...
    if (itmask[i] != MASK_FALSE) {
      ...
      if (my_rates->cloudy_metal.grid_rank == 1) {
        FORTRAN_NAME(interpolate_1d_g)(
            ...
            my_rates->cloudy_metal.grid_parameters[0], &dclPar[0],
            &my_rates->cloudy_metal.data_size,
            my_rates->cloudy_metal.cooling_data, &log_cool[i]);
        ...
        if ((my_chemistry->cmb_temperature_floor == 1) &&
          ...
          FORTRAN_NAME(interpolate_1d_g)(
              ...
              my_rates->cloudy_metal.grid_parameters[0], &dclPar[0],
              &my_rates->cloudy_metal.data_size,
              my_rates->cloudy_metal.cooling_data, &log_cool_cmb[i]);
        ...
        if (my_chemistry->UVbackground == 1) {
          FORTRAN_NAME(interpolate_1d_g)(
              ...
              my_rates->cloudy_metal.grid_parameters[0], &dclPar[0],
              &my_rates->cloudy_metal.data_size,
              my_rates->cloudy_metal.heating_data, &log_heat[i]);
        ...
        FORTRAN_NAME(interpolate_2d_g)(
            ...
            my_rates->cloudy_metal.grid_parameters[0], &dclPar[0],
            my_rates->cloudy_metal.grid_parameters[1], &dclPar[1],
            &my_rates->cloudy_metal.data_size,
            my_rates->cloudy_metal.cooling_data, &log_cool[i]);
        edot_met[i] = -std::pow(10., log_cool[i]);
        ...
        FORTRAN_NAME(interpolate_4d_g)(
            ...
            my_rates->cloudy_metal.grid_parameters[1], &dclPar[1],
            my_rates->cloudy_metal.grid_parameters[2], &dclPar[2],
            my_rates->cloudy_metal.grid_parameters[3], &dclPar[3],
            &my_rates->cloudy_metal.data_size,
            my_rates->cloudy_metal.cooling_data, &log_cool[i]);
        edot_met[i] = -std::pow(10., log_cool[i]);
