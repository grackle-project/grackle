...
void grackle::impl::calc_all_tdust_gasgr_1d_g(
    ...
    if (itmask_metal[i] != MASK_FALSE) {
      if (my_chemistry->dust_species == 0) {
        ...
        if (my_chemistry->use_multiple_dust_temperatures == 0) {
          mygisrf[i] = my_rates->gamma_isrf2 *
  ...
  if (my_chemistry->use_multiple_dust_temperatures == 0) {
    grackle::impl::calc_tdust_1d_g(
        tdust, tgas, nh, gasgr_tdust, mygisrf.data(),
        myisrf, itmask_metal, trad, my_fields->grid_dimension[0], gr_N[1],
        &dlog10Tdust, log10Tdust_vals, internal_dust_prop_buf.dyntab_kappa_tot, kptot,
    ...
    if (my_chemistry->dust_species > 0) {
        grackle::impl::calc_tdust_1d_g(
            ...
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::MgSiO3_dust],
    ...
    if (my_chemistry->dust_species > 1) {
        ...
        grackle::impl::calc_tdust_1d_g(
            ...
            gasgr_tMg2SiO4.data(), gisrfMg2SiO4.data(), myisrf, itmask_metal, trad,
            my_fields->grid_dimension[0], gr_N[1], &dlog10Tdust, log10Tdust_vals,
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::Mg2SiO4_dust],
        ...
        grackle::impl::calc_tdust_1d_g(
            ...
            my_fields->grid_dimension[0], gr_N[1], &dlog10Tdust, log10Tdust_vals,
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::Fe3O4_dust],
        ...
        grackle::impl::calc_tdust_1d_g(
            ...
            my_fields->grid_dimension[0], gr_N[1], &dlog10Tdust, log10Tdust_vals,
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::Al2O3_dust],
    ...
    if (my_chemistry->dust_species > 2) {
        grackle::impl::calc_tdust_1d_g(
            ...
            my_fields->grid_dimension[0], gr_N[1], &dlog10Tdust, log10Tdust_vals,
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::ref_org_dust],
        ...
        grackle::impl::calc_tdust_1d_g(
            ...
            my_fields->grid_dimension[0], gr_N[1], &dlog10Tdust, log10Tdust_vals,
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::vol_org_dust],
        ...
        grackle::impl::calc_tdust_1d_g(
            ...
            my_fields->grid_dimension[0], gr_N[1], &dlog10Tdust, log10Tdust_vals,
            internal_dust_prop_buf.grain_dyntab_kappa.data[OnlyGrainSpLUT::H2O_ice_dust],
