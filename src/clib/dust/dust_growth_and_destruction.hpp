...
// micron, and tau_ref values stored in Myr. The returned rates are equivalent
// rates whose product with dt gives the exponential e-folding mass update.
...
// Destruction uses exponential decay; returned rates are equivalent rates whose
// product with dt gives the e-folding mass loss.
