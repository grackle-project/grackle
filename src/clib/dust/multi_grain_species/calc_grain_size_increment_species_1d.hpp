...
///     \p opac_coef_table_data. The first element specifies the number of
///     opacity polynomial coefficients provided at every dust Temperature and
///     the second element specifies the number of dust Temperatures.
