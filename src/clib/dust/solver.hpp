...
public:
  ...
  ///     that Grackle evolves (if any) in a format that allows the values to
  ///     be accessed with the index lookup table. Wherever possible, data
  ///     should be accessed through this argument, rather than through
  ///     @p my_fields
