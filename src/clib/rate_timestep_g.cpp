...
)
{
  ...
  if (my_chemistry->primordial_chemistry == 1)  {
    ...
    for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
      if (itmask[i] != MASK_FALSE)  {
        ...
        dedot[i] =
                 + kcr_buf.data[CollisionalRxnLUT::k1][i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)*de(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kcr_buf.data[CollisionalRxnLUT::k3][i]*HeI(i,idx_range.jp1-1,idx_range.kp1-1)*de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 + kcr_buf.data[CollisionalRxnLUT::k5][i]*HeII(i,idx_range.jp1-1,idx_range.kp1-1)*de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 - kcr_buf.data[CollisionalRxnLUT::k2][i]*HII(i,idx_range.jp1-1,idx_range.kp1-1)*de(i,idx_range.jp1-1,idx_range.kp1-1)
                 - kcr_buf.data[CollisionalRxnLUT::k4][i]*HeII(i,idx_range.jp1-1,idx_range.kp1-1)*de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 - kcr_buf.data[CollisionalRxnLUT::k6][i]*HeIII(i,idx_range.jp1-1,idx_range.kp1-1)*de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 + kcr_buf.data[CollisionalRxnLUT::k57][i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)*HI(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kcr_buf.data[CollisionalRxnLUT::k58][i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)*HeI(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 +      ( kshield_buf.k24[i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kshield_buf.k25[i]*HeII(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 + kshield_buf.k26[i]*HeI(i,idx_range.jp1-1,idx_range.kp1-1)/4.);
    ...
    for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
      if (itmask[i] != MASK_FALSE)  {
        HIdot[i] =
              -      kcr_buf.data[CollisionalRxnLUT::k1][i] *de(i,idx_range.jp1-1,idx_range.kp1-1)    *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              -      kcr_buf.data[CollisionalRxnLUT::k7][i] *de(i,idx_range.jp1-1,idx_range.kp1-1)    *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              -      kcr_buf.data[CollisionalRxnLUT::k8][i] *HM(i,idx_range.jp1-1,idx_range.kp1-1)    *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              -      kcr_buf.data[CollisionalRxnLUT::k9][i] *HII(i,idx_range.jp1-1,idx_range.kp1-1)   *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              -      kcr_buf.data[CollisionalRxnLUT::k10][i]*H2II(i,idx_range.jp1-1,idx_range.kp1-1)  *HI(i,idx_range.jp1-1,idx_range.kp1-1)/2.
              - 2.*kcr_buf.data[CollisionalRxnLUT::k22][i]*std::pow(HI(i,idx_range.jp1-1,idx_range.kp1-1),2) *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              +      kcr_buf.data[CollisionalRxnLUT::k2][i] *HII(i,idx_range.jp1-1,idx_range.kp1-1)   *de(i,idx_range.jp1-1,idx_range.kp1-1)
              + 2.*kcr_buf.data[CollisionalRxnLUT::k13][i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)    *H2I(i,idx_range.jp1-1,idx_range.kp1-1)/2.
              +      kcr_buf.data[CollisionalRxnLUT::k11][i]*HII(i,idx_range.jp1-1,idx_range.kp1-1)   *H2I(i,idx_range.jp1-1,idx_range.kp1-1)/2.
              + 2.*kcr_buf.data[CollisionalRxnLUT::k12][i]*de(i,idx_range.jp1-1,idx_range.kp1-1)    *H2I(i,idx_range.jp1-1,idx_range.kp1-1)/2.
              +      kcr_buf.data[CollisionalRxnLUT::k14][i]*HM(i,idx_range.jp1-1,idx_range.kp1-1)    *de(i,idx_range.jp1-1,idx_range.kp1-1)
              +      kcr_buf.data[CollisionalRxnLUT::k15][i]*HM(i,idx_range.jp1-1,idx_range.kp1-1)    *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              + 2.*kcr_buf.data[CollisionalRxnLUT::k16][i]*HM(i,idx_range.jp1-1,idx_range.kp1-1)    *HII(i,idx_range.jp1-1,idx_range.kp1-1)
              + 2.*kcr_buf.data[CollisionalRxnLUT::k18][i]*H2II(i,idx_range.jp1-1,idx_range.kp1-1)  *de(i,idx_range.jp1-1,idx_range.kp1-1)/2.
              +      kcr_buf.data[CollisionalRxnLUT::k19][i]*H2II(i,idx_range.jp1-1,idx_range.kp1-1)  *HM(i,idx_range.jp1-1,idx_range.kp1-1)/2.
              -      kcr_buf.data[CollisionalRxnLUT::k57][i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)    *HI(i,idx_range.jp1-1,idx_range.kp1-1)
              -      kcr_buf.data[CollisionalRxnLUT::k58][i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)    *HeI(i,idx_range.jp1-1,idx_range.kp1-1)/4.
              -      kshield_buf.k24[i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)
              +   2.0*kshield_buf.k31[i] * H2I(i,idx_range.jp1-1,idx_range.kp1-1)/2.0;

        // Add H2 formation on dust grains

        if (anydust != MASK_FALSE)  {
          if (metal(i,idx_range.jp1-1,idx_range.kp1-1) > 1.e-9 * d(i,idx_range.jp1-1,idx_range.kp1-1))  {
            HIdot[i] = HIdot[i]
                 - 2. * h2dust[i] * rhoH[i] * HI(i,idx_range.jp1-1,idx_range.kp1-1);
          }
        }
        ...
        dedot[i] =
                 ...
                 + kcr_buf.data[CollisionalRxnLUT::k8][i] * HM(i,idx_range.jp1-1,idx_range.kp1-1)   * HI(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kcr_buf.data[CollisionalRxnLUT::k15][i]* HM(i,idx_range.jp1-1,idx_range.kp1-1)   * HI(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kcr_buf.data[CollisionalRxnLUT::k17][i]* HM(i,idx_range.jp1-1,idx_range.kp1-1)   * HII(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kcr_buf.data[CollisionalRxnLUT::k14][i]* HM(i,idx_range.jp1-1,idx_range.kp1-1)   * de(i,idx_range.jp1-1,idx_range.kp1-1)
                 - kcr_buf.data[CollisionalRxnLUT::k2][i] * HII(i,idx_range.jp1-1,idx_range.kp1-1)  * de(i,idx_range.jp1-1,idx_range.kp1-1)
                 - kcr_buf.data[CollisionalRxnLUT::k4][i] * HeII(i,idx_range.jp1-1,idx_range.kp1-1) * de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 - kcr_buf.data[CollisionalRxnLUT::k6][i] * HeIII(i,idx_range.jp1-1,idx_range.kp1-1)* de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 - kcr_buf.data[CollisionalRxnLUT::k7][i] * HI(i,idx_range.jp1-1,idx_range.kp1-1)   * de(i,idx_range.jp1-1,idx_range.kp1-1)
                 - kcr_buf.data[CollisionalRxnLUT::k18][i]* H2II(i,idx_range.jp1-1,idx_range.kp1-1) * de(i,idx_range.jp1-1,idx_range.kp1-1)/2.
                 + kcr_buf.data[CollisionalRxnLUT::k57][i]* HI(i,idx_range.jp1-1,idx_range.kp1-1)   * HI(i,idx_range.jp1-1,idx_range.kp1-1)
                 + kcr_buf.data[CollisionalRxnLUT::k58][i]* HI(i,idx_range.jp1-1,idx_range.kp1-1)   * HeI(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 + (kshield_buf.k24[i]*HI(i,idx_range.jp1-1,idx_range.kp1-1)
                 +  kshield_buf.k25[i]*HeII(i,idx_range.jp1-1,idx_range.kp1-1)/4.
        ...
        13.6*( kcr_buf.data[CollisionalRxnLUT::k1][i] * HI(i,idx_range.jp1-1,idx_range.kp1-1)   * de(i,idx_range.jp1-1,idx_range.kp1-1)
                 - kcr_buf.data[CollisionalRxnLUT::k2][i] * HII(i,idx_range.jp1-1,idx_range.kp1-1)  * de(i,idx_range.jp1-1,idx_range.kp1-1)          )
        + 24.6*( kcr_buf.data[CollisionalRxnLUT::k3][i] * HeI(i,idx_range.jp1-1,idx_range.kp1-1)  * de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 - kcr_buf.data[CollisionalRxnLUT::k4][i] * HeII(i,idx_range.jp1-1,idx_range.kp1-1) * de(i,idx_range.jp1-1,idx_range.kp1-1)/4. )
        + 79.0*( kcr_buf.data[CollisionalRxnLUT::k5][i] * HeII(i,idx_range.jp1-1,idx_range.kp1-1) * de(i,idx_range.jp1-1,idx_range.kp1-1)/4.
                 - kcr_buf.data[CollisionalRxnLUT::k6][i] * HeIII(i,idx_range.jp1-1,idx_range.kp1-1)* de(i,idx_range.jp1-1,idx_range.kp1-1)/4. )
              );
        ...
        h2heatfac[i] = std::pow((1. + (chemheatrates_buf.n_cr_n[i] / (dom *
             (HI(i,idx_range.jp1-1,idx_range.kp1-1) * chemheatrates_buf.n_cr_d1[i] +
             H2I(i,idx_range.jp1-1,idx_range.kp1-1) * 0.5 * chemheatrates_buf.n_cr_d2[i])))),(-1.));
        ...
        H2delta[i] =
            HI(i,idx_range.jp1-1,idx_range.kp1-1) *
             ( (3.53 * kcr_buf.data[CollisionalRxnLUT::k8] [i] * HM(i,idx_range.jp1-1,idx_range.kp1-1)
              + 4.48 * kcr_buf.data[CollisionalRxnLUT::k22][i] * std::pow(HI(i,idx_range.jp1-1,idx_range.kp1-1),2.))
              * h2heatfac[i]
              - 4.48 * kcr_buf.data[CollisionalRxnLUT::k13][i] * H2I(i,idx_range.jp1-1,idx_range.kp1-1)/2.);
        ...
        if (anydust != MASK_FALSE)  {
          if (metal(i,idx_range.jp1-1,idx_range.kp1-1) > 1.e-9 * d(i,idx_range.jp1-1,idx_range.kp1-1))  {
            H2delta[i] = H2delta[i] +
                 h2dust[i] * HI(i,idx_range.jp1-1,idx_range.kp1-1) * rhoH[i] *
                 (0.2 + 4.2 * h2heatfac[i]);
          }
        }
  ...
  if (my_chemistry->use_radiative_transfer == 1)  {
    if (my_chemistry->radiative_transfer_hydrogen_only == 0)  {
      for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
        if (itmask[i] != MASK_FALSE)  {
          HIdot[i] = HIdot[i] - kphHI(i,idx_range.jp1-1,idx_range.kp1-1)*HI(i,idx_range.jp1-1,idx_range.kp1-1);
          dedot[i] = dedot[i] + kphHI(i,idx_range.jp1-1,idx_range.kp1-1)*HI(i,idx_range.jp1-1,idx_range.kp1-1)
               + kphHeI(i,idx_range.jp1-1,idx_range.kp1-1) * HeI(i,idx_range.jp1-1,idx_range.kp1-1) / 4.
               + kphHeII(i,idx_range.jp1-1,idx_range.kp1-1) * HeII(i,idx_range.jp1-1,idx_range.kp1-1) / 4.;
        }
      }
    } else {
      for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
    ...
    if ((my_chemistry->primordial_chemistry > 2) && (my_chemistry->radiative_transfer_HDI_dissociation > 0))  {
      for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
        if (itmask[i] != MASK_FALSE)  {
          HIdot[i] = HIdot[i]
            + kdissHDI(i,idx_range.jp1-1,idx_range.kp1-1) * HDI(i,idx_range.jp1-1,idx_range.kp1-1)/3.0;
        }
      }
    }
    if ((my_chemistry->metal_chemistry > 0) && (my_chemistry->radiative_transfer_metal_ionization > 0))  {
      for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
        if (itmask[i] != MASK_FALSE)  {
          dedot[i] = dedot[i]
            + kphCI(i,idx_range.jp1-1,idx_range.kp1-1) * CI(i,idx_range.jp1-1,idx_range.kp1-1)/12.0
            + kphOI(i,idx_range.jp1-1,idx_range.kp1-1) * OI(i,idx_range.jp1-1,idx_range.kp1-1)/16.0;
        }
      }
    }
    if ((my_chemistry->metal_chemistry > 0) && (my_chemistry->radiative_transfer_metal_dissociation > 0))  {
      for (i = idx_range.i_start; i<=idx_range.i_end; i++) {
        if (itmask[i] != MASK_FALSE)  {
          HIdot[i] = HIdot[i]
            + kdissOH (i,idx_range.jp1-1,idx_range.kp1-1) * OH(i,idx_range.jp1-1,idx_range.kp1-1) /17.0
            + kdissH2O(i,idx_range.jp1-1,idx_range.kp1-1) * H2O(i,idx_range.jp1-1,idx_range.kp1-1)/18.0;
        }
      }
    }
  }
