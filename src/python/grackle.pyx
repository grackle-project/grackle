...
cdef extern from "grackle.h":
    ...
    gr_int initialize_chemistry_data(chemistry_data &my_chemistry,
                                  code_units &my_units, gr_float a_value)

    gr_int solve_chemistry(chemistry_data &my_chemistry,
                code_units &my_units,
    ...
    gr_int calculate_cooling_time(chemistry_data &my_chemistry,
                   code_units &my_units,
                   gr_float a_value, gr_float dt_value,
                   gr_int grid_rank, gr_int *grid_dimension,
                   gr_int *grid_start, gr_int *grid_end,
    ...
    gr_int calculate_gamma(chemistry_data &my_chemistry,
                        code_units &my_units,
                        gr_int grid_rank, gr_int *grid_dimension,
                        gr_float *density, gr_float *internal_energy,
                        gr_float *HI_density, gr_float *HII_density, gr_float *HM_density,
    ...
    gr_int calculate_pressure(chemistry_data &my_chemistry,
                           code_units &my_units,
                           gr_int grid_rank, gr_int *grid_dimension,
                           gr_float *density, gr_float *internal_energy,
                           gr_float *HI_density, gr_float *HII_density, gr_float *HM_density,
    ...
    gr_int calculate_temperature(chemistry_data &my_chemistry,
                              code_units &my_units,
                              gr_int grid_rank, gr_int *grid_dimension,
                              gr_float *density, gr_float *internal_energy,
                              gr_float *HI_density, gr_float *HII_density, gr_float *HM_density,
