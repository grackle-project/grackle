...
cdef c_field_data setup_field_data(object fc, int[::1] buf,
    ...
    my_fields.DM_density = get_field(fc, "DM")
    my_fields.HDII_density = get_field(fc, "HDII")
    my_fields.HeHII_density = get_field(fc, "HeHII")
    my_fields.CI_density = get_field(fc, "CI")
    my_fields.CII_density = get_field(fc, "CII")
    my_fields.CO_density = get_field(fc, "CO")
    my_fields.CO2_density = get_field(fc, "CO2")
    my_fields.OI_density = get_field(fc, "OI")
    my_fields.OH_density = get_field(fc, "OH")
    my_fields.H2O_density = get_field(fc, "H2O")
    my_fields.O2_density = get_field(fc, "O2")
    my_fields.SiI_density = get_field(fc, "SiI")
    my_fields.SiOI_density = get_field(fc, "SiOI")
    my_fields.SiO2I_density = get_field(fc, "SiO2I")
    my_fields.CH_density = get_field(fc, "CH")
    my_fields.CH2_density = get_field(fc, "CH2")
    my_fields.COII_density = get_field(fc, "COII")
    my_fields.OII_density = get_field(fc, "OII")
    my_fields.OHII_density = get_field(fc, "OHII")
    my_fields.H2OII_density = get_field(fc, "H2OII")
    my_fields.H3OII_density = get_field(fc, "H3OII")
    my_fields.O2II_density = get_field(fc, "O2II")
