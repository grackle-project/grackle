"""
This is a vendored version of tomli version 1.2.3
-> This code is licensed under the MIT

This is a fallback option:
    - when using python >= 3.11, prefer tomllib (built-in library)
    - if the tomli package is installed, prefer that
    - using a python version before 3.11
"""
# disable ruff, since we don't own this code
# ruff: noqa

__all__ = ("loads", "load", "TOMLDecodeError")

# =========================
# contents of tomli._types
# =========================
